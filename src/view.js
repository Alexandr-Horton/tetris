export default class View {
    ...
    _renderPanel({ level, score, lines, nextPiece }) {
        ...
        this.context.fillText(`↑ - spin`, this.panelX, this.panelY + 192);
        this.context.fillText(`↓ - move down`, this.panelX, this.panelY + 216);
        this.context.fillText(`Enter - Pause`, this.panelX, this.panelY + 240);
